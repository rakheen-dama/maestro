...
public record RetryPolicy(
    ...
    /**
     * Converts an {@link io.maestro.core.annotation.RetryPolicy} annotation
     * to this runtime configuration record.
     *
     * @param annotation the annotation to convert
     * @return the runtime retry policy
     */
    public static RetryPolicy fromAnnotation(io.maestro.core.annotation.RetryPolicy annotation) {
        return new RetryPolicy(
