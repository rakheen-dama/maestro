...
import io.b2mash.maestro.spring.config.WorkflowRegistrar;
...
public final class MaestroClient {
     ...
     *
     * @param workflowClass the {@link io.b2mash.maestro.core.annotation.DurableWorkflow}-annotated class
