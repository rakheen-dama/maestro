...
Self-recovery works identically regardless of your choice of messaging backend (Kafka or Postgres) or lock backend (Valkey or Postgres). PostgreSQL is always the authoritative store for workflow state.
