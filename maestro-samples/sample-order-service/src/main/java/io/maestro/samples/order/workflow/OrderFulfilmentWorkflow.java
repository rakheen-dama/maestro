package io.maestro.samples.order.workflow;
...
import io.maestro.samples.order.activity.InventoryActivities;
import io.maestro.samples.order.activity.MessagingActivities;
import io.maestro.samples.order.activity.NotificationActivities;
import io.maestro.samples.order.activity.ShippingActivities;
import io.maestro.samples.order.domain.OrderInput;
import io.maestro.samples.order.domain.OrderResult;
