package io.b2mash.maestro.samples.rabbitmqorder.workflow;
...
import io.b2mash.maestro.samples.rabbitmqorder.activity.InventoryActivities;
import io.b2mash.maestro.samples.rabbitmqorder.activity.MessagingActivities;
import io.b2mash.maestro.samples.rabbitmqorder.activity.NotificationActivities;
import io.b2mash.maestro.samples.rabbitmqorder.activity.ShippingActivities;
import io.b2mash.maestro.samples.rabbitmqorder.domain.OrderInput;
import io.b2mash.maestro.samples.rabbitmqorder.domain.OrderResult;
...
public class OrderFulfilmentWorkflow {
    ...
    public OrderResult fulfil(OrderInput input) {
        ...
        // Step 2: Request payment via RabbitMQ
