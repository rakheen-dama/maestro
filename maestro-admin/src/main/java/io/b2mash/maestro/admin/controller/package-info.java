 ...
 *
 * <p>{@link io.b2mash.maestro.admin.controller.DashboardController} serves full Thymeleaf pages
 * for the overview, workflow list, detail, failed, signals, and timers views.
 *
 * <p>{@link io.b2mash.maestro.admin.controller.AdminActionController} handles mutation actions
 * (retry, terminate, signal) that publish commands back to workflow services via Kafka.
 *
 * <p>{@link io.b2mash.maestro.admin.controller.FragmentController} serves HTMX fragment responses
